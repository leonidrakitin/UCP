    ...
    <section class="content">
        <div class="container">
            ...
            <form action="../admin/update_request_info.php" method="post">
                <input type='hidden' name='req' value='<? echo $character['id']; ?>'>
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <div class="form-group">
                                    <textarea class="form-control" rows="2" name="admin_answer"required></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-xs-6">
                        ...
                        onclick="return confirm('Are you sure you want to aprove the character?')"
                        value="Aprove">
                    </div>
                    <div class="col-xs-6">
                        <input type="submit" name="decline" class="btn btn-block btn-danger"
                        onclick="return confirm('Are you sure you want to denie the character?')"
                        value="Denie">
                    </div>
                </div>
            </form>
